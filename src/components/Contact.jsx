...
const Contact = () => {
    ...
    emailjs
      .send(
        ...
        import.meta.env.VITE_APP_EMAILJS_TEMPLATE_ID,
        {
          ...
          to_email: "sachin.kumar2021@iic.ac.in",
  ...
  return (
    <div
      className={`xl:mt-12 lg:flex-row flex xl:flex-row flex-col-reverse gap-10 overflow-hidden`}
    >
      <motion.div
      ...
      >
        ...
        >
          <label className='flex flex-col'>
            <span className='text-white font-small mb-1'>Your Name</span>
            <input
              type='text'
              name='name'
              value={form.name}
